...
var RequiredTextArea = React.createClass({displayName: 'RequiredTextArea',
    ...
    render: function () {
        ...
        return this.transferPropsTo(React.DOM.textarea( {onChange:this._onChange, className:controlClass, value:this.state.value} ));
}
