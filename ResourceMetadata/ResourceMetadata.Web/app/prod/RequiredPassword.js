...
var RequiredTextbox = React.createClass({displayName: 'RequiredTextbox',
    ...
    render: function () {
        ...
        return this.transferPropsTo(React.DOM.input( {type:"password", onChange:this.onChange, className:controlClass, value:this.state.value}   ));
}
