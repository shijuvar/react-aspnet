...
var RequiredEmail = React.createClass({displayName: 'RequiredEmail',
    ...
    render: function () {
        ...
        return this.transferPropsTo(React.DOM.input( {type:"email", onChange:this._onChange, className:controlClass}  ));
}
